...
const admin_login=()=>(
        ...
        <div id='login_page' class='d-flex justify-content-center align-items-center '>
            ...
            <form  id='gen_form'>
                ...
                <h2 id='welcome_text' class='text-secondary text-center'>Welcome Admin</h2>
                ...
                <div class='form-group'>
                    ...
                    <p id='sign_up' class='text-center'>New to Doseer? <span><Link id='link' to="/SignUp">Sign Up now</Link></span> </p>
                </div>
            </form>
